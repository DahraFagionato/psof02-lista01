...
app.post('/tipoTriangulo', (req, res) => {
...
app.post('/6numerosinteiros', (req, res) => {
...
app.post('/5numerosinteiros', (req, res) => {
    const { numeros } = req.body;
...
app.post('/2numerosinteiros', (req, res) => {
...
app.post('/reajujstesalarial', (req, res) => {
...
app.post('/descontosloja', (req, res) => {
